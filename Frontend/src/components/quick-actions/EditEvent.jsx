...
const EditEvent = () => {
  ...
  const validateStep = () => {
    if (step === 1 && !formData.sport) {
      toast.error('Please select a sport'); return false;
    }
    if (step === 2) {
                ...
                {step === 3 && (
                  <div>
                      ...
                      {formData.participationType === 'player' ? (
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-[10px] text-gray-600 mt-0.5">How many players can join</p>
                          </div>
                          <div className="flex items-center gap-2">
                            <button type="button"
                        ...
                        <>
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-[10px] text-gray-600 mt-0.5">How many teams will compete</p>
                            </div>
                            <div className="flex items-center gap-2">
                              <button type="button"
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-[10px] text-gray-600 mt-0.5">Players per team</p>
                            </div>
                            <div className="flex items-center gap-2">
                              <button type="button"
                    ...
                    <div className="mt-4 flex items-start gap-2.5 bg-[#ccff00]/5 border border-[#ccff00]/20 rounded-xl px-4 py-3">
                      ...
                      <p className="text-[11px] text-gray-400">This event will only be visible to students from your college</p>
                    </div>
                  </div>
                )}
